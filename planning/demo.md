...
1. ### Student players
   Verifies their identity before creating a profile. The system then retrieves and automatically populates verified football information such as playing position, preferred foot, skill level, and performance statistics from a simulated player registry. Players can complete additional profile information such as their biography, profile image, and availability.

2. ### Team captains/ coaches:
   Can browse player profiles, search for players based on specific criteria, maintain a scouting list, and invite promising players to team tryouts.
